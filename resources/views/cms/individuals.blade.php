      ...
      <div class="col-md-12">
        ...
        <div class="box">
          ...
          <div class="box-body pad">
            <button type="button" class="btn btn-primary btn-xs"  data-toggle="modal" data-target="#createClientModal"><i class="menu-item-icon icon ion-ios-plus-outline tx-20"></i> Add Individual </button>
<div class="row row-sm mg-t-50">
@foreach($donations as $gallery)
          <div class="col-lg-4">
