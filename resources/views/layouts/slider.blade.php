        ...
        <div class="col">
          ...
          <rs-module-wrap id="rev_slider_1_1_wrapper" data-alias="soolhart-html-revslider" data-source="gallery" style="background:transparent;padding:0;margin:0px auto;margin-top:0;margin-bottom:0;">
            <rs-module id="rev_slider_1_1" style="display:none;" data-version="6.1.7">
              <rs-slides>
                <rs-slide data-key="rs-40" data-title="Slide 1" data-thumb="http://placehold.it/1920x1280" data-anim="ei:d;eo:d;s:d;r:0;t:slotslide-horizontal;sl:d;">
                  <img src="{{ asset($general->slider1) }}" title="slide1" width="1920" height="1280" data-parallax="off" class="rev-slidebg" data-no-retina>
                  <rs-layer
                    ...
                    >Welcome to <strong>{{$site->site_name}}</strong>
                  </rs-layer>
                  <rs-layer
                ...
                <rs-slide data-key="rs-43" data-title="Slide 1" data-thumb="http://placehold.it/1920x1280" data-anim="ei:d;eo:d;s:d;r:0;t:slotslide-horizontal;sl:d;">
                  ...
                  <rs-layer
                    ...
                    style="z-index:8;"
                    ><a href="#about" class="btn btn-lg btn-bordered btn-theme-colored1 text-white">Learn More</a>
                    <a href="#causes" class="btn btn-lg btn-bordered btn-theme-colored1 text-white">Make Donation</a>
                  </rs-layer>
                  <rs-layer
