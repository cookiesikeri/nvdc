...
<head>
    ...
    <link rel="icon" href="{{asset('img/favicons/android-chrome-512x512.png')}}" sizes="512x512" type="image/png">
    <link rel="icon" href="{{asset('img/favicons/android-chrome-192x192.png"')}}" sizes="192x192" type="image/png">
    ...
    <link rel="icon" href="{{asset('img/favicons/apple-touch-icon.png')}}" sizes="180x180" type="image/png">
