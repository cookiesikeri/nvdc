                ...
                <div class="tm-sc-icon-box icon-box animate-icon-on-hover animate-icon-rotate-y mb-sm-30 bg-theme-colored1 p-60 section-typo-light">
                  <div class="icon-box-wrapper">
                    ...
                    <div class="icon-text">
                      ...
                      <p class="icon-box-title mt-0" style="visibility: hidden">We would like to impr <br>hgt</p>
                    </div>
                ...
                <div class="tm-sc-icon-box icon-box animate-icon-on-hover animate-icon-rotate-y mb-sm-30 bg-theme-colored2 p-60 section-typo-light">
                  <div class="icon-box-wrapper">
                    ...
                    <div class="icon-text">
                      ...
                      <p class="icon-box-title mt-0" style="visibility: hidden">We would like to improvehh hh <br><br>gg <br></p>
                      <p ></p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group mb-0 mt-0">
                                ...
                                <button type="button" class="btn btn-theme-colored btn-round"  style="color: black"><a href="{{ route('donate') }}" target="_blank"> Donate USD</a></button>
                            </div>
                        </div>
                    </div>
                </form>
