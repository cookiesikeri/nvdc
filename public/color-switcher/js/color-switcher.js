...
jQuery(document).ready(function($) {
    ...
    $('#switcher-boxed-layout-variations2 a').on('click', function(e) {
        ...
        if( layout_width == "container-1140px" ) {
            $('body').removeClass('container-1340px').removeClass('container-970px').removeClass('container-100pr');
        } else if( layout_width == "container-1340px" ) {
            $('body').addClass('container-1340px').removeClass('container-970px').removeClass('container-100pr');
        } else if( layout_width == "container-970px" ) {
            $('body').addClass('container-970px').removeClass('container-1340px').removeClass('container-100pr');
        } else if( layout_width == "container-100pr" ) {
            $('body').addClass('container-100pr').removeClass('container-1340px').removeClass('container-970px');
        }
        return false;
    });
    ...
    $('#switcher-boxed-layout-variations2').on('change', function (e) {
        ...
        if( valueSelected == "container-1140px" ) {
            $('body').removeClass('container-1340px').removeClass('container-970px').removeClass('container-100pr');
        } else if( valueSelected == "container-1340px" ) {
            $('body').addClass('container-1340px').removeClass('container-970px').removeClass('container-100pr');
        } else if( valueSelected == "container-970px" ) {
            $('body').addClass('container-970px').removeClass('container-1340px').removeClass('container-100pr');
        } else if( valueSelected == "container-100pr" ) {
            $('body').addClass('container-100pr').removeClass('container-1340px').removeClass('container-970px');
        }
    ...
    $('#switcher-boxed-layout-variations').on('change', function (e) {
        ...
        switch(valueSelected) {
            case "container-1340px":
                $("body").removeClass (function (index, className) {
                    return (className.match (/(^|\s)container-\S+/g) || []).join(' ');
                });
                $('body').addClass('container-1340px');
            break;
            
            case "container-1600px":
                $("body").removeClass (function (index, className) {
                    return (className.match (/(^|\s)container-\S+/g) || []).join(' ');
                });
                $('body').addClass('container-1600px');
            break;

            case "container-1500px":
                $("body").removeClass (function (index, className) {
                    return (className.match (/(^|\s)container-\S+/g) || []).join(' ');
                });
                $('body').addClass('container-1500px');
            break;

            case "container-1440px":
                $("body").removeClass (function (index, className) {
                    return (className.match (/(^|\s)container-\S+/g) || []).join(' ');
                });
                $('body').addClass('container-1440px');
            break;

            case "container-1230px":
                $("body").removeClass (function (index, className) {
                    return (className.match (/(^|\s)container-\S+/g) || []).join(' ');
                });
                $('body').addClass('container-1230px');
            break;

            case "container-970px":
                $("body").removeClass (function (index, className) {
                    return (className.match (/(^|\s)container-\S+/g) || []).join(' ');
                });
                $('body').addClass('container-970px');
            break;

            case "container-100pr":
                $("body").removeClass (function (index, className) {
                    return (className.match (/(^|\s)container-\S+/g) || []).join(' ');
                });
                $('body').addClass('container-100pr');
            break;
